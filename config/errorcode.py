def errors(err_code):
    ...
    err_dic = {0: ('OP_ERR_NONE', '정상처리'),
               ...
               -201: ('OP_ERR_RQ_STRING_FAIL', '전문작성입력값오류'),
               ...
               -301: ('OP_ERR_ORD_WRONG_ACCTNO', '계좌번호없음'),
               -302: ('OP_ERR_OTHER_ACC_USE', '타인계좌사용오류'),
               -303: ('OP_ERR_MIS_5BILL_EXC', '주문가격이20억초과'),
               -304: ('OP_ERR_MIS_5BILL_EXC', '주문가격이50억초과'),
               -305: ('OP_ERR_MIS_1PER_EXC', '주문수량이총발행주수위1 % 초과오류'),
               -306: ('OP_ERR_MIS_3PER_EXC', '주문수량이총발행주수위3 % 초과오류'),
               ...
               -340: ('OP_ERR_ORD_WRONG_ACCTINFO', '계좌정버없음'),
